...
import (
	...
	"github.com/jhonasalves/go-expert-fc-clean-arch/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrder2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Order(ctx, sel, v)
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋjhonasalvesᚋgoᚑexpertᚑfcᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
